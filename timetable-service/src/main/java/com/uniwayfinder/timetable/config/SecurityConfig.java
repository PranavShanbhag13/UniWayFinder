package com.uniwayfinder.timetable.config;

import com.uniwayfinder.timetable.config.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/timetable/v3/api-docs/**", "/v3/api-docs/**", "/swagger-ui/**").permitAll()
